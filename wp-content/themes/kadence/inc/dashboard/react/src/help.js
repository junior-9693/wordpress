	...
	return (
		<div className="kadence-desk-help-inner">
			...
			<div className="video-container">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/I2KEpE_iH3M" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			<a href="https://kadence-theme.com/documentation/" className="kadence-desk-button" target="_blank">{ __( 'View Knowledge Base', 'kadence' ) }</a>
		</div>
	);
};
